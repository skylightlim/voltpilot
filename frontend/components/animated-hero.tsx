    ...
    <section className="mx-auto max-w-6xl px-4 sm:px-6 pt-10 pb-20 sm:pb-28">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col items-start">
          <h1 className="apple-display text-[42px] font-bold text-ink sm:text-[56px] lg:text-[62px] leading-[1.05]">
            {t("hero.t1")}
            <br />
            <span className="text-primary">{t("hero.t2")}</span>
          </h1>

          <p className="mt-5 max-w-xl text-[17px] sm:text-[18px] leading-relaxed text-fog">
            {t("hero.sub")}
          </p>
          ...
          <div className="mt-8 flex items-center gap-2 text-[15px] font-medium text-muted">
        ...
        <div id="calculator" className="lg:col-span-5">
          <div className="rounded-lg border border-line bg-white p-6 sm:p-7 shadow-xl card-highlight">
            ...
            <div className="mt-4 rounded-md bg-pine-deep p-4 text-white dark-card-highlight">
            ...
            <div className="mt-4">
              <Link href="/interview/form" className="block w-full">
                <Button variant="primary" size="md" className="w-full text-[16px]">
