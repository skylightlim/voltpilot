...
const S = {
  ...
  "iq.annualHint": ["That works out to about {km} km a year.",
                    "Itu bersamaan kira-kira {km} km setahun."],
  "iq.annualHigh": ["That works out to about {km} km a year — high, but real for e-hailing. Check question 1 asks about a DAY, not a week.",
                    "Itu bersamaan kira-kira {km} km setahun — tinggi, tetapi biasa untuk e-hailing. Pastikan soalan 1 bertanya tentang satu HARI, bukan seminggu."],
  ...
  "calcs.title": ["Calculators", "Kalkulator"],
  "calcs.h1": ["What a car really costs", "Kos sebenar sebuah kereta"],
  "calcs.sectionCar": ["A specific car", "Kereta tertentu"],
  "calcs.which": ["Which car", "Kereta yang mana"],
  "calcs.notListed": ["A car not in the list", "Kereta yang tiada dalam senarai"],
  "calcs.useOwn": ["Use my own figures", "Guna angka saya sendiri"],
  "calcs.backToCar": ["Pick from the catalogue instead", "Pilih dari katalog sebaliknya"],
  "calcs.custom": ["Your own figures", "Angka anda sendiri"],
  "calcs.drivetrain": ["Drivetrain", "Pacuan"],
  "calcs.ev": ["Electric", "Elektrik"],
  "calcs.hybrid": ["Hybrid", "Hibrid"],
  "calcs.phev": ["Plug-in hybrid", "Hibrid palam masuk"],
  "calcs.yourTerms": ["Your terms", "Terma anda"],
  "calcs.carFacts": ["This car", "Kereta ini"],
  "calcs.useThisCar": ["Use this car", "Guna kereta ini"],
  "calcs.siNote": [
    "Insured at the car's price, which is how a new policy is written.",
    "Dilindungi pada harga kereta, sebagaimana polisi baharu ditulis.",
  ],
  "calcs.needsCatalogCar": [
    "This needs a car from the catalogue. It runs the model's measured consumption and its fitted resale curve, and neither can be inferred from a price alone.",
    "Ini memerlukan kereta dari katalog. Ia menggunakan penggunaan tenaga model yang diukur dan lengkung nilai jualan semulanya, dan kedua-duanya tidak boleh diagak dari harga sahaja.",
  ],
  "calcs.needsCcForTax": [
    "Electric cars are rated on motor power under a JPJ schedule this site does not hold, so a road tax figure is only available for a car from the catalogue.",
    "Kereta elektrik dikadarkan mengikut kuasa motor di bawah jadual JPJ yang tidak disimpan di sini, jadi angka cukai jalan hanya tersedia untuk kereta dari katalog.",
  ],
  "calcs.priceLockedNote": [
    "The figures below come from this car. To change the price or engine, switch to your own figures.",
    "Angka di bawah datang dari kereta ini. Untuk menukar harga atau enjin, tukar ke angka anda sendiri.",
  ],
  "calcs.engine": ["Engine", "Enjin"],
  "calcs.electricNoEngine": ["No engine", "Tiada enjin"],

  "calcs.afford": ["What can I afford?", "Apa yang saya mampu?"],
  "calcs.budget": ["Monthly budget (RM)", "Bajet bulanan (RM)"],
  "calcs.maxPrice": ["You can reach", "Anda boleh capai"],
  "calcs.inRange": ["cars in range", "kereta dalam julat"],
  "calcs.afforded": ["Dearest in range", "Termahal dalam julat"],
  "calcs.depreciation": ["What will it be worth?", "Berapa nilainya nanti?"],
  "calcs.afterYears": ["After 5 years", "Selepas 5 tahun"],
  "calcs.valueThen": ["Resale value", "Nilai jualan semula"],
  "calcs.lost": ["Value lost", "Nilai hilang"],
  "calcs.measured": ["Fitted from this model's own used listings", "Diukur dari senarai terpakai model ini sendiri"],
  "calcs.typeCurve": ["Estimated from all cars of this drivetrain, not this model alone", "Dianggarkan dari semua kereta pacuan ini, bukan model ini sahaja"],
  ...
  "calcs.depNote": [
    "Depreciation is about 68% of what a car costs over five years — far more than fuel or charging.",
    "Susut nilai adalah kira-kira 68% daripada kos kereta selama lima tahun — jauh lebih daripada bahan api atau pengecasan.",
  ],

  "nav.calcs": ["Calculators", "Kalkulator"],
  "calcs.lede": [
    "Run the same figures the recommendation is built from, against your own numbers.",
    "Kira angka yang sama yang digunakan dalam cadangan, dengan nombor anda sendiri.",
  ],
  "calcs.pick": ["Start from a car", "Mula dengan sebuah kereta"],
  "calcs.pickNone": ["Enter my own figures", "Masukkan angka saya sendiri"],
  "calcs.loan": ["Car loan", "Pinjaman kereta"],
  "calcs.insurance": ["Insurance", "Insurans"],
  "calcs.roadTax": ["Road tax", "Cukai jalan"],
  "calcs.price": ["Car price (RM)", "Harga kereta (RM)"],
  "calcs.down": ["Down payment (RM)", "Bayaran pendahuluan (RM)"],
  "calcs.tenure": ["Tenure (years)", "Tempoh (tahun)"],
  "calcs.rate": ["Flat rate (% p.a.)", "Kadar rata (% setahun)"],
  "calcs.monthly": ["Monthly instalment", "Ansuran bulanan"],
  "calcs.totalInterest": ["Total interest", "Jumlah faedah"],
  "calcs.totalPayable": ["Total payable", "Jumlah kena bayar"],
  "calcs.eir": ["Effective rate", "Kadar berkesan"],
  "calcs.eirNote": [
    "A flat rate charges interest on the full amount for the whole term, so the effective rate is roughly double it. The Hire Purchase (Amendment) Act 2026 requires this figure to be disclosed.",
    "Kadar rata mengenakan faedah atas jumlah penuh sepanjang tempoh, jadi kadar berkesan lebih kurang dua kali ganda. Akta Sewa Beli (Pindaan) 2026 mewajibkan angka ini didedahkan.",
  ],
  "calcs.si": ["Sum insured (RM)", "Jumlah dilindungi (RM)"],
  "calcs.policyYear": ["Policy year", "Tahun polisi"],
  "calcs.ncd": ["No-claim discount", "Diskaun tanpa tuntutan"],
  "calcs.premium": ["Annual premium", "Premium tahunan"],
  "calcs.east": ["Sabah / Sarawak", "Sabah / Sarawak"],
  "calcs.cc": ["Engine capacity (cc)", "Kapasiti enjin (cc)"],
  "calcs.nonSaloon": ["SUV, MPV or pickup", "SUV, MPV atau pikap"],
  "calcs.annual": ["Annual road tax", "Cukai jalan tahunan"],
  "calcs.evLookup": [
    "Electric vehicles are rated on motor power under a JPJ schedule this site does not hold, so the figure shown is the one published for that model.",
    "Kenderaan elektrik dikadarkan mengikut kuasa motor di bawah jadual JPJ yang tidak disimpan di sini, jadi angka yang ditunjukkan adalah angka terbitan untuk model itu.",
  ],
  "calcs.basis": ["Source", "Sumber"],
  "calcs.perMonth": ["/month", "/bulan"],
  "calcs.perYear": ["/year", "/tahun"],
  "r.filterSeats": ["Filter by seats", "Tapis mengikut tempat duduk"],
  "r.allSeats": ["Any number of seats", "Sebarang bilangan tempat duduk"],
  "r.seatsPlus": ["{n}+ seats", "{n}+ tempat duduk"],
